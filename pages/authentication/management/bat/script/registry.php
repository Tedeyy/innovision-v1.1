...
// Uniqueness: firstname+lastname must be unique among BAT (review + preapproval)
...
if ($authHttp === 400) {
    header('Location: ' . (($APP_URL ? rtrim($APP_URL, '/') : '') . '/pages/authentication/management/bat/registrationform.html?email_taken=1'));
    exit;
}
...
$finalName = (($sanitized !== '') ? $sanitized : 'bat') . $ext;
